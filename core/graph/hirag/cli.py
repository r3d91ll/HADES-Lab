"""CLI helpers for HiRAG graph maintenance."""
...
from .service import HiragService
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="HiRAG graph tools")
    parser.add_argument(
        "--database",
