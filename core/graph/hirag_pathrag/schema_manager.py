"""Schema management helpers for the HiRAG × PathRAG graph."""
...
class GraphCollections:
    """Names of collections used by the HiRAG × PathRAG graph."""
...
class GraphSchemaManager:
    """Creates collections, indices, and named graph for HiRAG × PathRAG."""
    ...
    def _ensure_collections(self) -> None:
        ...
        try:
            ...
            logger.exception("Failed to ensure HiRAG × PathRAG collections")
            raise
